...
*   `/resources [concept]` / `Show resources [concept]`: Run `python3 replay.py resources [concept]`. In your response, list the resources output by the script, and immediately follow it with a fun, engaging, and analogy-driven breakdown of the concept (using real-world analogies, gamified framing, and ascii/mermaid flow diagrams) to make it highly intuitive.
